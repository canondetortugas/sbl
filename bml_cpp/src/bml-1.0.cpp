...
namespace bml
{
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // constraint
      //
      if (n.name () == "constraint" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // gaze
      //
      if (n.name () == "gaze" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // wait
      //
      if (n.name () == "wait" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // headOrientation
      //
      if (n.name () == "headOrientation" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // posture
      //
      if (n.name () == "posture" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // postureShift
      //
      if (n.name () == "postureShift" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // speech
      //
      if (n.name () == "speech" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // gesture
      //
      if (n.name () == "gesture" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // pointing
      //
      if (n.name () == "pointing" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // face
      //
      if (n.name () == "face" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // faceLexeme
      //
      if (n.name () == "faceLexeme" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // locomotion
      //
      if (n.name () == "locomotion" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // head
      //
      if (n.name () == "head" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // headDirectionShift
      //
      if (n.name () == "headDirectionShift" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // synchronize
      //
      if (n.name () == "synchronize" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // before
      //
      if (n.name () == "before" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // after
      //
      if (n.name () == "after" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // sync
      //
      if (n.name () == "sync" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
         ...
         ::xml_schema::flags f)
  {
    ...
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // text
      //
      if (n.name () == "text" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
         ...
         ::xml_schema::flags f)
  {
    ...
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // pose
      //
      if (n.name () == "pose" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
      ...
      // stance
      //
      if (n.name () == "stance" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
         ...
         ::xml_schema::flags f)
  {
    ...
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // lexeme
      //
      if (n.name () == "lexeme" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
        ::std::auto_ptr< lexeme_type > r (
          lexeme_traits::create (i, f, this));
         ...
         ::xml_schema::flags f)
  {
    for (; p.more_elements (); p.next_element ())
    {
      ...
      // required
      //
      if (n.name () == "required" && n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
      {
...
namespace bml
{
        ...
        const ::xml_schema::properties& p)
  {
    ...
    if (n.name () == "bml" &&
        n.namespace_ () == "http://www.bml-initiative.org/bml/bml-1.0")
    {
      ::std::auto_ptr< ::bml::bml > r (
...
namespace bml
{
  ...
  void
  bml_ (::xercesc::XMLFormatTarget& t,
        const ::bml::bml& s,
        const ::xml_schema::namespace_infomap& m,
        const ::std::string& e,
        ::xml_schema::flags f)
  ...
  void
  operator<< (::xercesc::DOMElement& e, const requiredType& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);

    // constraint
    //
    for (requiredType::constraint_const_iterator
    ...
    // gaze
    //
    for (requiredType::gaze_const_iterator
         b (i.gaze ().begin ()), n (i.gaze ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // wait
    //
    for (requiredType::wait_const_iterator
         b (i.wait ().begin ()), n (i.wait ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // headOrientation
    //
    for (requiredType::headOrientation_const_iterator
         b (i.headOrientation ().begin ()), n (i.headOrientation ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // posture
    //
    for (requiredType::posture_const_iterator
         b (i.posture ().begin ()), n (i.posture ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // postureShift
    //
    for (requiredType::postureShift_const_iterator
         b (i.postureShift ().begin ()), n (i.postureShift ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // speech
    //
    for (requiredType::speech_const_iterator
         b (i.speech ().begin ()), n (i.speech ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // gesture
    //
    for (requiredType::gesture_const_iterator
         b (i.gesture ().begin ()), n (i.gesture ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // pointing
    //
    for (requiredType::pointing_const_iterator
         b (i.pointing ().begin ()), n (i.pointing ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // face
    //
    for (requiredType::face_const_iterator
    ...
    // faceLexeme
    //
    for (requiredType::faceLexeme_const_iterator
         b (i.faceLexeme ().begin ()), n (i.faceLexeme ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // locomotion
    //
    for (requiredType::locomotion_const_iterator
         b (i.locomotion ().begin ()), n (i.locomotion ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // head
    //
    for (requiredType::head_const_iterator
         b (i.head ().begin ()), n (i.head ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // headDirectionShift
    //
    for (requiredType::headDirectionShift_const_iterator
         b (i.headDirectionShift ().begin ()), n (i.headDirectionShift ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
  ...
  void
  operator<< (::xercesc::DOMElement& e, const behaviorType& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const constraintType& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const synchronizeType& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);

    // sync
    //
    for (synchronizeType::sync_const_iterator
         b (i.sync ().begin ()), n (i.sync ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
  ...
  void
  operator<< (::xercesc::DOMElement& e, const beforeType& i)
  {
    e << static_cast< const ::bml::synchronizeType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const afterType& i)
  {
    e << static_cast< const ::bml::synchronizeType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const syncRefType& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const waitType& i)
  {
    e << static_cast< const ::bml::behaviorType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const gazeType& i)
  {
    e << static_cast< const ::bml::behaviorType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const gestureType& i)
  {
    e << static_cast< const ::bml::behaviorType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const syncType& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);
  ...
  operator<< (::xercesc::DOMElement& e, const textType& i)
  {
    ...
    // sync
    //
    for (textType::sync_const_iterator
         b (i.sync ().begin ()), n (i.sync ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
  ...
  void
  operator<< (::xercesc::DOMElement& e, const speech& i)
  {
    e << static_cast< const ::bml::behaviorType& > (i);

    // text
    //
    for (speech::text_const_iterator
  ...
  void
  operator<< (::xercesc::DOMElement& e, const postureType& i)
  {
    e << static_cast< const ::bml::behaviorType& > (i);

    // pose
    //
    for (postureType::pose_const_iterator
         b (i.pose ().begin ()), n (i.pose ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
  ...
  void
  operator<< (::xercesc::DOMElement& e, const faceAbstractType& i)
  {
    e << static_cast< const ::bml::behaviorType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const faceLexemeType& i)
  {
    e << static_cast< const ::bml::faceAbstractType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const syncBlock& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);

    // sync
    //
    for (syncBlock::sync_const_iterator
         b (i.sync ().begin ()), n (i.sync ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
  ...
  void
  operator<< (::xercesc::DOMElement& e, const targetID& i)
  {
    e << static_cast< const ::xml_schema::string& > (i);
  }

  void
  operator<< (::xercesc::DOMAttr& a, const targetID& i)
  {
  ...
  void
  operator<< (::xercesc::DOMElement& e, const openSetItem& i)
  {
    e << static_cast< const ::xsd::cxx::tree::list< ::xml_schema::string, char >& > (i);
  }

  void
  operator<< (::xercesc::DOMAttr& a, const openSetItem& i)
  {
  ...
  void
  operator<< (::xercesc::DOMElement& e, const closedSetItem& i)
  {
    e << static_cast< const ::xsd::cxx::tree::list< ::xml_schema::string, char >& > (i);
  }

  void
  operator<< (::xercesc::DOMAttr& a, const closedSetItem& i)
  {
    a << static_cast< const ::xsd::cxx::tree::list< ::xml_schema::string, char >& > (i);
  }
  ...
  void
  operator<< (::xml_schema::list_stream& l,
              const closedSetItem& i)
  {
    l << static_cast< const ::xsd::cxx::tree::list< ::xml_schema::string, char >& > (i);
  }

  void
  operator<< (::xercesc::DOMElement& e, const pointingType& i)
  {
    e << static_cast< const ::bml::behaviorType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const locomotionType& i)
  {
    e << static_cast< const ::bml::behaviorType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const headDirectionShiftType& i)
  {
    e << static_cast< const ::bml::behaviorType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const faceFacs& i)
  {
    e << static_cast< const ::bml::faceAbstractType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const faceShiftType& i)
  {
    e << static_cast< const ::bml::faceAbstractType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const lexemeType& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const headType& i)
  {
    e << static_cast< const ::bml::behaviorType& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const stanceType& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);
  ...
  void
  operator<< (::xercesc::DOMElement& e, const bml& i)
  {
    e << static_cast< const ::xml_schema::type& > (i);

    // required
    //
    for (bml::required_const_iterator
         b (i.required ().begin ()), n (i.required ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
        ::xsd::cxx::xml::dom::create_element (
    ...
    // constraint
    //
    for (bml::constraint_const_iterator
         b (i.constraint ().begin ()), n (i.constraint ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
    ...
    // headOrientation
    //
    for (bml::headOrientation_const_iterator
         b (i.headOrientation ().begin ()), n (i.headOrientation ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
    ...
    // posture
    //
    for (bml::posture_const_iterator
         b (i.posture ().begin ()), n (i.posture ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
    ...
    // postureShift
    //
    for (bml::postureShift_const_iterator
         b (i.postureShift ().begin ()), n (i.postureShift ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
    ...
    // gesture
    //
    for (bml::gesture_const_iterator
         b (i.gesture ().begin ()), n (i.gesture ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
    ...
    // pointing
    //
    for (bml::pointing_const_iterator
         b (i.pointing ().begin ()), n (i.pointing ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
    ...
    // faceLexeme
    //
    for (bml::faceLexeme_const_iterator
         b (i.faceLexeme ().begin ()), n (i.faceLexeme ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
    ...
    // locomotion
    //
    for (bml::locomotion_const_iterator
         b (i.locomotion ().begin ()), n (i.locomotion ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
    ...
    // headDirectionShift
    //
    for (bml::headDirectionShift_const_iterator
         b (i.headDirectionShift ().begin ()), n (i.headDirectionShift ().end ());
         b != n; ++b)
    {
      ::xercesc::DOMElement& s (
